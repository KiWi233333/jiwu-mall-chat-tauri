...
<template>
  <div
    v-bind="$attrs"
    class="group w-16vw flex flex-col animate-[fade-in-right_300ms] gap-2 border-(0 l-1px default) p-0 px-0 transition-200 transition-width sm:(relative w-16vw flex-col p-4)"
  >
