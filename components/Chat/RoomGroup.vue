...
<template>
  ...
  >
        ...
        <div :class="isGrid ? 'flex-row is-grid' : 'flex-col'" relative flex flex-wrap gap-2 md:gap-0>
          ...
          >
            <div class="relative flex-row-c-c" :title="p.nickName || '未知'">
              ...
              />
              <small v-else class="h-2.4rem w-2.4rem flex-row-c-c rounded-1/2 text-center leading-2.4rem border-default">
    ...
    <BtnElButton
      class="op-0 group-hover:op-100" icon-class="i-solar:logout-3-broken sm:mr-2" type="danger" plain round
