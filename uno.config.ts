...
export default defineConfig({
  shortcuts: [
    ...
    ["border-default-2-t", "border-b-(1px #7e7e7e0e solid) dark:border-dark-300 border-opacity-5"],
    ["border-default-2-b", "border-t-(1px #7e7e7e0e solid) dark:border-dark-300 border-opacity-5"],
