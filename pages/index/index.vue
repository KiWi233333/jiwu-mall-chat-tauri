...
<template>
  <div :class="{ 'flex-1 w-full': !chat.theContact.roomId }">
    <!-- 空白 -->
    <div v-if="!chat.theContact.roomId" data-fades class="h-full w-full flex flex-1 flex-col items-center justify-center rounded-0 text-gray-600 border-default-l card-default dark:(text-gray-500)">
